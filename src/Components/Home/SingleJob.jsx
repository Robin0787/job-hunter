...
const SingleJob = ({job}) => {
    ...
    return (
        <div className='border rounded-md p-6 relative'>
            ...
            <button className='text-indigo-500 border text-xs border-indigo-400 px-2 py-1 rounded-sm'>{remoteOrOnsite}</button>
            <button className='text-indigo-500 border text-xs border-indigo-400 px-2 py-1 rounded-sm'>{fulltimeOrPartTime}</button>
            </div>
            <div className='flex items-center gap-4 text-xs my-4 text-gray-600'>
